    ...
    Programadas.forEach((Citas) => {
      let fila = `
        <tr>
          ...
          <td>${Citas.password !== undefined ? Citas.password  : ""}</td>
...
btnEnviar.addEventListener('click', async (e) => {
    ...
    const pass = document.getElementById("passwordUsers").value;
...
tabla.addEventListener("click", (event) => {
    ...
    const rolTabla = fila.querySelector('td:nth-child(5)').textContent.trim();
